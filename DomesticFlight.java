...
public class DomesticFlight extends JFrame {
    ...
    public DomesticFlight(LoginPage type1) {
        ...
        BFindFlight.addActionListener(new ButtonHandler(this, type1));
    }

    public static void main(String args[]) {
        LoginPage type1 = new LoginPage(); // You need to instantiate the LoginPage
...
class ButtonHandler implements ActionListener {
    ...
    ButtonHandler(DomesticFlight type, LoginPage type1) {
        this.type = type;
        this.type1 = type1;
    }
        ...
        if (iSeatCount > 60) {
            ...
            if (iChoice == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    for (i = 0; i < iCount; i++) {
                        Save2 temp1 = new Save2(sTempFrom[i], sTempTo[i], sTempClass[i], iTempAdult[i], iTempChildren[i],
                                iTempInfant[i], sTempBookingDate[i], iTempPrice[i], sTempTime[i]);
